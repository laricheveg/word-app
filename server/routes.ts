...
import UserWordController from './controllers/user-word';
...
export default function setRoutes(app) {
  ...
  const userWordController = new UserWordController();
  ...
  // words
  router.route('/user/word').post(userWordController.update);
  router.route('/user/word/').get(userWordController.findById);
  router.route('/user/word/').delete(userWordController.destroy);  
  // ----------------------------------------------------  
